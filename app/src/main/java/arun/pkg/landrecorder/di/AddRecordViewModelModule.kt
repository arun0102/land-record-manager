...
import arun.pkg.landrecorder.ui.addrecord.AddRecordViewModel
import dagger.Binds
 ...
 */
@Module
interface AddRecordViewModelModule {
    @Binds
    @IntoMap
    @ViewModelKey(AddRecordViewModel::class)
    fun bindAddRecordViewModel(viewModel: AddRecordViewModel): ViewModel
}

@Module
interface AddRecordFragmentModule {
    @ContributesAndroidInjector(modules = [AddRecordViewModelModule::class])
    fun addRecordFragment(): AddRecordFragment
}
